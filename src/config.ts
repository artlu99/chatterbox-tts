...
export const API_ENDPOINT =
	...
	"https://api.runpod.ai/v2/chatterbox-turbo/runsync?wait=60000";
...
export const FFMPEG_TIMEOUT_MS = parseInt(
	process.env.FFMPEG_TIMEOUT_MS ?? "60000",
	10,
);
export const FFMPEG_MAX_RETRIES = parseInt(
	process.env.FFMPEG_MAX_RETRIES ?? "3",
	10,
);
export const FFMPEG_FETCH_TIMEOUT_MS = parseInt(
	process.env.FFMPEG_FETCH_TIMEOUT_MS ?? "30000",
	10,
);
...
export const MAX_STDIN_BYTES = parseInt(
	process.env.MAX_STDIN_BYTES ?? "1048576",
	10,
);
